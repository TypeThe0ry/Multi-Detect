...
macro(_qgc_discover_android_sdk)
    ...
    # The upstream tarball stores libpng.pc as a symlink to libpng16.pc.
    # Windows hosts without symlink privilege omit it during extraction, which
    # makes gstopengl's pkg-config dependency resolution fail even though the
    # plugin and libpng archives are present.
    if(CMAKE_HOST_WIN32)
