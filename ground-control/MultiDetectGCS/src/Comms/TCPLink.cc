...
void TCPWorker::setupSocket()
{
    ...
    // MAVLink TCP links are explicit point-to-point connections. Do not let
    // the application-wide web proxy configuration redirect a vehicle link
    // through an HTTP proxy (which QTcpSocket may reject outright).
