...
struct CommandLineParseResult
{
    ...
    bool offlineMode = false;  ///< Isolated UI validation with all vehicle links inhibited
    bool isolatedHilMode = false;  ///< Clean settings, no auto-connect, explicit HIL links allowed
