...
class VehicleFactGroup : public FactGroup
{
    ...
    Q_PROPERTY(Fact *airSpeedDisplay        READ airSpeedDisplay        CONSTANT)
...
public:
    ...
    Fact *airSpeedDisplay() { return &_airSpeedDisplayFact; }
...
protected:
    ...
    Fact _airSpeedDisplayFact = Fact(0, QStringLiteral("airSpeedDisplay"), FactMetaData::valueTypeDouble);
...
private:
    ...
    // Display-only hysteresis. The raw AirSpeed Fact always retains VFR_HUD telemetry.
    bool _airSpeedDisplayActive = false;
};
